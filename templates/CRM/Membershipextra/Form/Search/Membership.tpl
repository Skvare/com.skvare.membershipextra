        ...
        <div class="crm-accordion-body">
            <div id="searchForm" class="crm-block crm-form-block crm-contact-custom-search-activity-search-form-block">
                ...
                <table class="form-layout-compressed">
                    <tr class="crm-contact-custom-search-form-row">
                        <td class="label">{$form.includeMemTypes.label}</td><td>{$form.includeMemTypes.html}</td>
                    </tr>
                    <tr class="crm-contact-custom-search-form-row">
                        <td colspan="1" class="label">{$form.memStatus.label}</td><td>{$form.memStatus.html}</td>
                    </tr>
                    <tr class="crm-contact-custom-search-form-row">
                        <td colspan="2">---------------------------------------------------------------<br/><br/></td>
                    </tr>
                    <tr class="crm-contact-custom-search-form-row">
                        <td class="label">{$form.excludeMemTypes.label}</td><td>{$form.excludeMemTypes.html}</td>
                    </tr>
                    <tr class="crm-contact-custom-search-form-row">
                        <td colspan="1" class="label">{$form.excludeMemStatus.label}</td><td>{$form.excludeMemStatus.html}<br/><br/><br/><br/></td>
                    </tr>
                </table>

                <table class="form-layout-compressed">
                    <tr><td colspan="1"><label>{ts}Member Since{/ts}</label></td></tr>
                    <tr>
                        {include file="CRM/Core/DateRange.tpl" fieldName="member_join_date" from='_low' to='_high'}
                    </tr>

                    <tr><td colspan="1"><label>{ts}Start Date{/ts}</label></td></tr>
                    <tr>
                        {include file="CRM/Core/DateRange.tpl" fieldName="member_start_date" from='_low' to='_high'}
                    </tr>

                    <tr><td colspan="1"><label>{ts}End Date{/ts}</label></td></tr>
                    <tr>
