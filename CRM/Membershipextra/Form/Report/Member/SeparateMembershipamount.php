...
class CRM_Membershipextra_Form_Report_Member_SeparateMembershipamount extends CRM_Report_Form {
  ...
  public function from() {
    ...
    if ($this->_addressField || (!empty($this->_params['state_province_id_value']) || !empty($this->_params['country_id_value']))) {
      $this->_from .= "
